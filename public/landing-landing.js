...
const TREATMENTS_META = {
  ...
  'body-thai-hot-oil': {
    ...
    price: { he: '60 דק׳ – 190₾ · 90 דק׳ – 240₾', en: '60 min – 190₾ · 90 min – 240₾', ru: '60 мин – 190₾ · 90 min – 240₾', ka: '60 წთ – 190₾ · 90 წთ – 240₾' }
  },
...
/* =========================================================
   ✅ Video Slider (3 videos) — prev/next + dots + autoplay
   ========================================================= */
function setupVideoSlider() {
  ...
  const setActive = async (i) => {
    ...
    // play active, pause others (מפחית באגים/מסך שחור)
    slides.forEach((s, idx) => {
      const v = s.querySelector('video');
      if (!v) return;

      if (idx === index) {
        // נסה להפעיל (מותר כי muted + playsinline)
        const p = v.play();
