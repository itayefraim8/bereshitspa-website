...
const LOCAL_STRINGS = {
  ...
  ru: {
    'landing.hero.eyebrow': 'Japanese Head Spa и тайский массаж — Батуми',
...
const TREATMENTS_META = {
  'head-spa': {
    ...
    desc: {
      ...
      ru: 'Традиционный японский ритуал: очищение, массаж кожи головы, маски и тёплая водная терапия. Улучшает кровообращение, поддерживает корни волос и глубоко расслабляет. Включает мытьё, горячее полотенце, сыворотку для кожи головы и полную сушку. Завершается коротким отдыхом с чаем и лёгким ароматом. (90 мин включает массаж рук и ног)',
      ka: 'ტრადიციული იაპონური რიტუალი: წმენდა, თავის კანის მასაჟი, ნიღბები და თბილი წყლის თერაპია. აძლიერებს სისხლის მიმოქცევას, ამაგრებს თმის ფესვებს და ღრმად ამშვიდებს. მოიცავს დაბანას, ცხელ პირსახოცს, თავის კანის სერუმს და სრულ გაშრობას. ბოლოს — მოკლე დასვენება ჩაით და ნაზ არომატთან ერთად. (90 წთ მოიცავს ხელებისა და ფეხების მასაჟს)'
    },
    price: {
