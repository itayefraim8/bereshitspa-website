...
function applyLang(lang) {
  ...
  applyTreatmentTexts(lang); // ✅ תרגום כרטיסי טיפולים
}
...
const LOCAL_STRINGS = {
  ...
  en: {
    ...
    'landing.hero.subtitle': 'Choose your treatment, pick a time and complete secure card payment – all in one page.',
  ...
  ru: {
    ...
    'landing.hero.subtitle': 'Выберите процедуру, удобное время и оплатите банковской картой на одной странице.',
  ...
  ka: {
    ...
    'landing.hero.subtitle': 'აირჩიეთ პროცედურა, დაგეგმეთ დრო და განახორციელეთ უსაფრთხო ბარათით გადახდა — ერთ გვერდზე.',
...
// ===== תוספת אחידה לטיפולי גוף (body-*) =====
const BODY_ADDON = {
  he: 'עיסוי גוף מלא מכף רגל ועד ראש כולל עיסוי פנים.',
  en: 'Full-body massage from feet to head, including a face massage.',
  ru: 'Массаж всего тела от стоп до головы, включая массаж лица.',
  ka: 'მთლიანი სხეულის მასაჟი ტერფებიდან თავამდე, სახის მასაჟის ჩათვლით.'
};
...
const TREATMENTS_META = {
  ...
  // ===== טיפולי גוף: הוספת המשפט + תרגומים =====
  'body-thai': {
    name: { he: 'עיסוי תאילנדי מסורתי', en: 'Traditional Thai Massage', ru: 'Традиционный тайский массаж', ka: 'ტრადიციული ტაილანდური მასაჟი' },
    desc: {
      he: 'טיפול עתיק ללא שמן המשלב לחיצות, מתיחות ועבודה על קווי האנרגיה. ' + BODY_ADDON.he,
      en: 'Ancient oil-free treatment with pressure, stretches and work on energy lines. ' + BODY_ADDON.en,
      ru: 'Древняя процедура без масла с надавливаниями, растяжками и работой по энергетическим линиям. ' + BODY_ADDON.ru,
      ka: 'უძველესი პროცედურა ზეთის გარეშე – წერტილოვანი დაწოლა, გაჭიმვები და ენერგეტიკულ ხაზებზე მუშაობა. ' + BODY_ADDON.ka
    },
  ...
  'body-thai-oil': {
    ...
    desc: {
      he: 'עיסוי גוף מלא בשמן חם בתנועות זורמות ועמוקות, לשחרור עומס שרירי. ' + BODY_ADDON.he,
      en: 'Full-body massage with warm oil, combining flowing and deeper strokes to release muscular tension. ' + BODY_ADDON.en,
      ru: 'Массаж всего тела тёплым маслом с плавными и глубокими приёмами для снятия мышечного напряжения. ' + BODY_ADDON.ru,
      ka: 'მთლიანი სხეულის მასაჟი თბილი ზეთით – ნაზი და ღრმა მოძრაობების კომბინაცია კუნთოვანი დაძაბულობის მოსახსნელად. ' + BODY_ADDON.ka
    },
  ...
  'body-aroma': {
    ...
    desc: {
      he: 'שמנים אתריים טהורים בשילוב עיסוי גוף מרגיע ומלטף. ' + BODY_ADDON.he,
      en: 'Pure essential oils combined with a soothing, flowing full-body massage. ' + BODY_ADDON.en,
      ru: 'Натуральные эфирные масла в сочетании с мягким расслабляющим массажем всего тела. ' + BODY_ADDON.ru,
      ka: 'სუფთა ეთერზეთები და დამამშვიდებელი, მოლივლივე სხეულის მასაჟი. ' + BODY_ADDON.ka
    },
  ...
  'body-thai-ther': {
    ...
    desc: {
      he: 'עיסוי טיפולי עמוק עם לחיצות ממוקדות ומתיחות מדויקות – מתאים לכאבי גב וצוואר. ' + BODY_ADDON.he,
      en: 'Deep therapeutic massage with focused pressure and precise stretches – ideal for back and neck issues. ' + BODY_ADDON.en,
      ru: 'Глубокий лечебный массаж с прицельными надавливаниями и точными растяжками – подходит при болях в спине и шее. ' + BODY_ADDON.ru,
      ka: 'ღრმა თერაპიული მასაჟი მიზანმიმართული წნევით და ზუსტი გაჭიმვებით – რეკომენდებულია ზურგისა და კისრის ტკივილებზე. ' + BODY_ADDON.ka
    },
  ...
  'body-hot-stone': {
    ...
    desc: {
      he: 'אבני בזלת חמות מחליקות על הגוף וממיסות מתחים עמוקים – רוגע עמוק וזרימת דם טובה. ' + BODY_ADDON.he,
      en: 'Warm basalt stones glide along the whole body, melting deep tension and improving circulation. ' + BODY_ADDON.en,
      ru: 'Тёплые базальтовые камни скользят по всему телу, снимая глубокие напряжения и улучшая кровообращение. ' + BODY_ADDON.ru,
      ka: 'თბილი ბაზალტის ქვები სრიალებენ მთელ სხეულზე, ხსნიან ღრმა დაძაბულობას და აუმჯობესებენ სისხლის მიმოქცევას. ' + BODY_ADDON.ka
    },
  ...
  'body-thai-comp': {
    ...
    desc: {
      he: 'שקיות צמחים תאילנדים חמות מעניקות ריפוי טבעי, ניקוז עומק והקלה על כאבים. ' + BODY_ADDON.he,
      en: 'Warm Thai herbal pouches provide natural healing, deep drainage and pain relief. ' + BODY_ADDON.en,
      ru: 'Тёплые тайские травяные мешочки обеспечивают естественное восстановление, дренаж и облегчение боли. ' + BODY_ADDON.ru,
      ka: 'თბილი თაილანდური მცენარეული პაკეტები უზრუნველყოფენ ბუნებრივ განსაჯანსაღებლობას, ღრმა დრენაჟს და ტკივილის შემსუბუქებას. ' + BODY_ADDON.ka
    },
  ...
  'body-shiatsu': {
    ...
    desc: {
      he: 'עיסוי ללא שמן בלחיצות לאורך מרידיאנים – מאזן אנרגיה פנימית ומרגיע עומס נפשי. ' + BODY_ADDON.he,
      en: 'Oil-free pressure massage along meridians – balances inner energy and calms the mind. ' + BODY_ADDON.en,
      ru: 'Массаж без масла с нажатием по меридианам – уравновешивает внутреннюю энергию и успокаивает психику. ' + BODY_ADDON.ru,
      ka: 'ზეთის გარეშე წერტილოვანი მასაჟი მერიდიანების გასწვრივ – აბალანსებს შიდა ენერგიას და ამშვიდებს გონებას. ' + BODY_ADDON.ka
    },
    price: { he: "60 דק' – 180₾ · 90 דק' – 230₾", en: '60 min – 180₾ · 90 min – 230₾', ru: '60 мин – 180₾ · 90 мин – 230₾', ka: '60 წთ – 180₾ · 90 წთ – 230₾' }
  },
...
function applyTreatmentTexts(lang) {
  document.querySelectorAll('.product-card').forEach((card) => {
    ...
    // תיאור: הפסקה הראשונה שאינה .price
...
function setupTreatmentButtons() {
  ...
  buttons.forEach((btn) => {
    btn.addEventListener('click', (e) => {
      ...
      if (group) {
        const span =
          document.querySelector(`input[name="${group}"]:checked + span`) || null;
