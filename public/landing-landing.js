...
'body-Thai Oil Massage': {
  ...
  desc: {
    ...
    en: 'A full-body massage with quality oil using long, soft and flowing movements. Focuses on deep relaxation of the nervous system and stress reduction. Releases light tension and creates a sense of calm and balance. Suitable for those seeking a gentle, non-intensive experience. The treatment is performed as a full-body massage and also includes a facial massage.',
    ru: 'Массаж всего тела с качественным маслом, выполняемый длинными, мягкими и плавными движениями. Направлен на глубокое расслабление нервной системы и снижение стресса. Снимает лёгкое напряжение и дарит ощущение спокойствия и баланса. Подходит тем, кто ищет мягкий и неинтенсивный массаж. Процедура выполняется как массаж всего тела и также включает массаж лица.',
    ka: 'მთლიანი სხეულის მასაჟი ხარისხიანი ზეთით, გრძელი, რბილი და მოლივლივე მოძრაობებით. ფოკუსირებულია ნერვული სისტემის ღრმა მოდუნებასა და სტრესის შემცირებაზე. ხსნის მსუბუქ დაძაბულობას და ქმნის სიმშვიდისა და ბალანსის შეგრძნებას. შესაფერისია მათთვის, ვინც ეძებს ნაზ და არაინტენსიურ გამოცდილებას. პროცედურა სრულდება როგორც მთლიანი სხეულის მასაჟი და ასევე მოიცავს სახის მასაჟს.'
  },
  price: { he: '60 דק׳ – 150₾', en: '60 min – 150₾', ru: '60 мин – 150₾', ka: '60 წთ – 150₾' }
},
