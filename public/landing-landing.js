...
const TREATMENTS_META = {
  ...
  'facial-thai': {
    ...
    // ✅ לפי הבקשה: 60 דק׳ בלבד 150₾ (הוסר חצי שעה)
    price: { he: '60 דק׳ – 150₾', en: '60 min – 150₾', ru: '60 мин – 150₾', ka: '60 წთ – 150₾' }
  },
  ...
  // ✅ החלפה: Relaxing Oil Massage -> THAI OIL MASSAGE (אותו key כדי לא לשבור HTML)
  'body-relaxing-oil': {
  ...
  'body-thai': {
    ...
    // ✅ לפי הבקשה: להסיר 90 דקות, מחיר 140₾
  ...
  // ✅ שינוי: להסיר את המילה "קרם", להסיר 90, מחיר 170
  // (שומרים key כדי לא לשבור HTML)
